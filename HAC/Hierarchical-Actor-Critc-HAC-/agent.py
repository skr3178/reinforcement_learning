    ...
    def initialize_networks(self):
        ...
        if self.FLAGS.retrain == False:
            ...
            if latest_checkpoint is not None:
                ...
                if self.FLAGS.test:
                    raise ValueError("No saved model found in {0}. Please train a model first before testing.".format(self.model_dir))
                else:
                    print("WARNING: No saved model found in {0}. Starting from scratch.".format(self.model_dir))
